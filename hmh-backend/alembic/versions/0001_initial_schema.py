...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("role", postgresql.ENUM("OWNER","OFFICE_ADMIN","OFFICE_USER","SITE_MANAGER","SITE_STAFF", name="user_role_enum", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("PLANNED","ACTIVE","PAUSED","COMPLETED", name="project_status_enum", create_type=False), nullable=False, server_default="PLANNED"),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("DRAFT","UNDER_REVIEW","ACTIVE","SUPERSEDED","ARCHIVED", name="boq_status_enum", create_type=False), nullable=False, server_default="DRAFT"),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("AVAILABLE","IN_PROGRESS","COMPLETED","ON_HOLD", name="lot_status_enum", create_type=False), nullable=False, server_default="AVAILABLE"),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("NOT_STARTED","IN_PROGRESS","COMPLETED","AWAITING_INSPECTION","CERTIFIED", name="stage_status_enum", create_type=False), nullable=False, server_default="NOT_STARTED"),
    ...
    op.create_table(
        ...
        sa.Column("code", sa.String(100), nullable=True),
        sa.Column("description", sa.Text, nullable=True),
        sa.Column("item_type", postgresql.ENUM("MATERIAL","LABOUR","PLANT","SERVICE","PACKAGE", name="item_type_enum", create_type=False), nullable=False, server_default="MATERIAL"),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("DRAFT","SUBMITTED","APPROVED","REJECTED","SENT","RECEIVED","MATCHED","PAID","CANCELLED", name="record_status_enum", create_type=False), nullable=False, server_default="DRAFT"),
        sa.Column("notes", sa.Text, nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("DRAFT","SUBMITTED","APPROVED","REJECTED","SENT","RECEIVED","MATCHED","PAID","CANCELLED", name="record_status_enum", create_type=False), nullable=False, server_default="DRAFT"),
        sa.Column("vat_mode", postgresql.ENUM("INCLUSIVE","EXCLUSIVE", name="vat_mode_enum", create_type=False), nullable=False, server_default="EXCLUSIVE"),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("queued","sent","failed","bounced", name="email_status_enum", create_type=False), nullable=False, server_default="queued"),
    ...
    op.create_table(
        ...
        sa.Column("delivery_status", postgresql.ENUM("DRAFT","SUBMITTED","APPROVED","REJECTED","SENT","RECEIVED","MATCHED","PAID","CANCELLED", name="record_status_enum", create_type=False), nullable=False, server_default="RECEIVED"),
    ...
    op.create_table(
        ...
        sa.Column("boq_item_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("boq_items.id", ondelete="SET NULL"), nullable=True),
        sa.Column("movement_type", postgresql.ENUM("OPENING_BALANCE","DELIVERY_RECEIVED","USAGE","ADJUSTMENT_ADD","ADJUSTMENT_SUBTRACT","RETURN_TO_STORE","TRANSFER_IN","TRANSFER_OUT", name="movement_type_enum", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("match_status", postgresql.ENUM("MATCHED","PARTIALLY_MATCHED","MISMATCH","UNLINKED", name="invoice_match_status_enum", create_type=False), nullable=False, server_default="UNLINKED"),
    ...
    op.create_table(
        ...
        sa.Column("payment_type", postgresql.ENUM("SUPPLIER","LABOUR","OTHER", name="payment_type_enum", create_type=False), nullable=False),
        sa.Column("amount", sa.Numeric(14, 2), nullable=False),
        sa.Column("payment_date", sa.Date, nullable=False),
        sa.Column("reference", sa.String(255), nullable=True),
        sa.Column("status", postgresql.ENUM("PENDING","APPROVED","PAID","FAILED","CANCELLED", name="payment_status_enum", create_type=False), nullable=False, server_default="PENDING"),
        sa.Column("notes", sa.Text, nullable=True),
        sa.Column("created_by", postgresql.UUID(as_uuid=True), sa.ForeignKey("users.id", ondelete="SET NULL"), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    ...
    op.create_table(
        "attachments",
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True),
        sa.Column("entity_type", postgresql.ENUM("BOQ_HEADER","PURCHASE_ORDER","DELIVERY","INVOICE","USAGE_LOG","CERTIFICATION", name="attachment_entity_enum", create_type=False), nullable=False),
        sa.Column("entity_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("attachment_type", postgresql.ENUM("PHOTO","PDF","DELIVERY_NOTE","INVOICE_COPY","PROOF","CERTIFICATE", name="attachment_type_enum", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("reference_id", postgresql.UUID(as_uuid=True), nullable=True),
        sa.Column("alert_type", postgresql.ENUM("MATERIAL_OVERUSE","BOQ_VARIANCE_OVERUSE","DELIVERY_WITHOUT_PO","INVOICE_MISMATCH","INVOICE_MISSING_DELIVERY_NOTE","NEGATIVE_STOCK","LOW_STOCK","MISSING_REMAINING_STOCK_PHOTO","OVERDUE_PAYMENT","REQUEST_PENDING_TOO_LONG","DELIVERY_DISCREPANCY","DELIVERY_SIGNATURE_MISSING","VEHICLE_REPAIR_LOGGED","SITE_DELAY","PROJECT_OVER_BUDGET", name="alert_type_enum", create_type=False), nullable=False),
        sa.Column("severity", postgresql.ENUM("LOW","MEDIUM","HIGH","CRITICAL", name="alert_severity_enum", create_type=False), nullable=False, server_default="MEDIUM"),
        sa.Column("title", sa.String(255), nullable=False),
        sa.Column("message", sa.Text, nullable=False),
        sa.Column("status", postgresql.ENUM("OPEN","ACKNOWLEDGED","RESOLVED", name="alert_status_enum", create_type=False), nullable=False, server_default="OPEN"),
        sa.Column("target_role", postgresql.ENUM("OWNER","OFFICE_ADMIN","OFFICE_USER","SITE_MANAGER","SITE_STAFF", name="user_role_enum", create_type=False), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("project_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("projects.id", ondelete="CASCADE"), nullable=False),
        sa.Column("site_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("sites.id", ondelete="SET NULL"), nullable=True),
        sa.Column("fuel_type", postgresql.ENUM("DIESEL","PETROL","PARAFFIN","OTHER", name="fuel_type_enum", create_type=False), nullable=False),
        sa.Column("usage_type", postgresql.ENUM("EQUIPMENT","DELIVERY_VEHICLE","TRANSPORT","GENERATOR","OTHER", name="fuel_usage_type_enum", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("vehicle_type", postgresql.ENUM("BAKKIE","TRUCK","TLB","EXCAVATOR","CRANE","VAN","OTHER", name="vehicle_type_enum", create_type=False), nullable=False, server_default="OTHER"),
        sa.Column("status", postgresql.ENUM("ACTIVE","MAINTENANCE","RETIRED", name="vehicle_status_enum", create_type=False), nullable=False, server_default="ACTIVE"),
    ...
    op.create_table(
        ...
        sa.Column("cost_type", postgresql.ENUM("FUEL","TYRE","REPAIR","SERVICE","LICENCE","INSURANCE","OTHER", name="vehicle_cost_type_enum", create_type=False), nullable=False),
        sa.Column("amount", sa.Numeric(14, 2), nullable=False),
        sa.Column("description", sa.Text, nullable=True),
        sa.Column("project_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("projects.id", ondelete="SET NULL"), nullable=True),
        sa.Column("site_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("sites.id", ondelete="SET NULL"), nullable=True),
