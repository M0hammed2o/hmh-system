...
class VehicleCreate(BaseModel):
    ...
    fuel_consumption_per_hour: Optional[float] = None
    fuel_tolerance_pct: float = 20
    fuel_minimum_issue_interval_hours: float = 0
    fuel_override_required: bool = False
    hour_meter_required: bool = False
    tracker_provider: Optional[str] = None
    tracker_external_id: Optional[str] = None
...
class VehicleUpdate(BaseModel):
    ...
    fuel_consumption_per_100km: Optional[float] = None
    fuel_consumption_per_hour: Optional[float] = None
    fuel_tolerance_pct: Optional[float] = None
    fuel_minimum_issue_interval_hours: Optional[float] = None
    fuel_override_required: Optional[bool] = None
    hour_meter_required: Optional[bool] = None
    tracker_provider: Optional[str] = None
    tracker_external_id: Optional[str] = None
    current_odometer_km: Optional[float] = None
    service_interval_km: Optional[int] = None
